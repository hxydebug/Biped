...
int main(int argc, char **argv)
{
    ...
    // Pin_KinDyn kinDynSolver("/home/hesam/vicon_ws/src/biped/models/AzureLoong.urdf");
    ...
    // reset_motors();
    //test
    // cmd_transfer(3,&L_msgs[2],69*PII/180.0,0,8,0.2,0);
