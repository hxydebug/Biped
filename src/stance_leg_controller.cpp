...
Eigen::VectorXd stance_leg_controller::get_action(Eigen::VectorXd user_cmd){
    ...
    float m = 8.5;
    //I_b to I_w
    Eigen::Vector3d invI_b(1.0/0.46,1.0/0.44,1.0/0.146);//1.0/0.406,1.0/0.335,1.0/0.144
...
float body_mass = 8.5;
float alpha = 0.00001;
const std::vector<double> qp_weights {3,3,0, 0,0,50, 0,0,1, 1,1,0.1, 0}; // w,p,dw,dp,g
